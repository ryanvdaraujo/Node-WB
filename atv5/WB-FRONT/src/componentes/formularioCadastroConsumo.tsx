...
export default class FormularioCadastroConsumo extends Component<props, state> {
    ...
    renderCamposPesquisa() {
        let estiloTitulo = `center-align purple-text`
        let titulo = `${this.props.titulo}`
        let estiloBotaoAdd = `btn purple`
            ...
            <>
                ...
                <div className="row">
                    ...
                    <div className="col s2 xl1">
                        <button className={estiloBotaoAdd} style={{ marginTop: "15px" }} type="submit" name="action" onClick={this.handleAddItem} disabled={this.state.isCamposDesabilitados}>Adicionar
    ...
    renderRodape() {
        ...
        if (this.props.titulo === 'Visualização da Compra') {
            botaoRodape =
                <>
                    <button onClick={(e) => this.props.seletorView('Consumos', e)} className={estiloBotaoSair} type="button">voltar
            ...
            botaoRodape =
                <>
                    <button onClick={() => this.showToast('Compra salva com sucesso!')} className={estiloBotaoSalvar} type="submit" name="action">enviar
