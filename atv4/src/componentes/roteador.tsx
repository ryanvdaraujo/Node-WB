    ...
    render() {
        ...
        if (this.state.tela === 'Clientes') {
            return (
                <>
                    {barraNavegacao}
                    <ListaCliente seletorView={this.selecionarView} dadosClienteAtualizacao={this.state.dadosClienteAtualizacao} onDataChange={this.handleDataChange} titulo="Clientes" tema="pink lighten-2" />
                </>
            )
            ...
            return (
                <>
                    {barraNavegacao}
                    <ListaProdutoServico seletorView={this.selecionarView} titulo="Produtos/Serviços" tema="pink lighten-2" produtosServicos={listaProdutosServicos} />
                </>
            )
            ...
            return (
                <>
                    {barraNavegacao}
                    <ListaConsumo seletorView={this.selecionarView} titulo="Consumos" tema="pink lighten-2" consumos={listaConsumos} />
                </>
            )
            ...
            return (
                <>
                    {barraNavegacao}
                    <FormularioCadastroProdutoServico titulo="Cadastro de Item" tema="pink lighten-2" />
                </>
            )
            ...
            return (
                <>
                    {barraNavegacao}
                    <FormularioCadastroConsumo titulo="Nova Compra" tema="pink lighten-2" />
                </>
            )
            ...
            return (
                <>
                    {barraNavegacao}
                    <FormularioCadastroProdutoServico titulo="Alteração de Item" tema="pink lighten-2" />
                </>
            )
