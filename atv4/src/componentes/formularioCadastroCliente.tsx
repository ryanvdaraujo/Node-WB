                ...
                <div className="row">
                    <form className="col s12" onSubmit={(e) => this.submeterFormulario(e)}>
                        <div className="row">
                            ...
                            <div className="input-field col s6 x11">
                                <select defaultValue="NA" id="genero" className="validate" value={this.state.dadosCliente?.genero?.genero || ''} onChange={(e) => this.capturarGenero(e)}>
                                    <option value="NA">Prefiro não informar</option>
                                    <option value="Mulher">Mulher</option>
                                    <option value="Homem">Homem</option>
                                    <option value="Lgbtqia+">Lgbtqia+</option>
                                    <option value="Autobot">Autobot</option>
                                    <option value="Aviao">Avião de caça</option>


                                </select>
                                <label className="active" htmlFor="genero">Selecione o seu genero</label>
                            </div>
                        </div>
                        <div className="row">
