...
var CadastroProdutos = /** @class */ (function (_super) {
    ...
    function CadastroProdutos(produtos) {
    ...
    CadastroProdutos.prototype.cadastrar = function () {
        console.log("\n\u00CDnicio do cadastro de produto\n");
        var nomeProduto = this.entrada.receberTexto("Digite o nome do produto: ");
        var precoProduto = this.entrada.receberNumero("Digite o valor do produto: ");
