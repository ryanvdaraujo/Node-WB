...
var ListagemGeneroM = /** @class */ (function (_super) {
    __extends(ListagemGeneroM, _super);
    function ListagemGeneroM(clientes) {
        var _this = _super.call(this) || this;
        _this.clientes = clientes;
        return _this;
    }
    ListagemGeneroM.prototype.listar = function () {
    ...
    return ListagemGeneroM;
}(listagem_1.default));
exports.default = ListagemGeneroM;
